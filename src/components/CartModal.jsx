...
export default function CartModal({ isOpen, onClose }) {
  ...
  const qrDataUrl = `data:image/svg+xml;utf8,${encodeURIComponent(`
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300">
      ...
      <rect x="30" y="30" width="90" height="90" fill="#111827"/>
      <rect x="45" y="45" width="60" height="60" fill="#ffffff"/>
      <rect x="180" y="30" width="90" height="90" fill="#111827"/>
      <rect x="195" y="45" width="60" height="60" fill="#ffffff"/>
      <rect x="30" y="180" width="90" height="90" fill="#111827"/>
      <rect x="45" y="195" width="60" height="60" fill="#ffffff"/>
      <rect x="150" y="150" width="45" height="45" fill="#111827"/>
      <rect x="210" y="150" width="45" height="45" fill="#111827"/>
      <rect x="150" y="210" width="45" height="45" fill="#111827"/>
      <rect x="90" y="120" width="15" height="15" fill="#111827"/>
      <rect x="120" y="120" width="15" height="15" fill="#111827"/>
      <rect x="120" y="90" width="15" height="15" fill="#111827"/>
      <rect x="240" y="120" width="15" height="15" fill="#111827"/>
      <text x="150" y="260" text-anchor="middle" font-family="Arial, sans-serif" font-size="24" fill="#111827">Yape / Plin</text>
    </svg>
  `)}`
  ...
  const finalizarPorWhatsApp = async () => {
    ...
    try {
      await createOrder({
        ...
        total: totalFinal,
        items: cart.map((item) => ({ name: item.name, qty: item.qty, size: item.size }))
      })
          ...
          {mostrarQR ? (
            <div className="flex flex-col items-center text-center space-y-6">
              ...
              <div className="bg-white p-3 rounded-xl shadow-lg border-4 border-stone-800">
                <img src={qrDataUrl} alt="QR de Pago" className="w-48 h-48 sm:w-56 sm:h-56 object-contain" />
              </div>
